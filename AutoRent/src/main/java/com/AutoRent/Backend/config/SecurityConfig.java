    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/pagos/*/aprobar", "/api/pagos/*/rechazar").hasRole("ADMINISTRADOR")
                        ...
                        .requestMatchers(HttpMethod.PUT, "/api/reservas/**").hasAnyRole("PROPIETARIO", "ADMINISTRADOR")
